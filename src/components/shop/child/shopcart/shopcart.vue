...
<template>
<div>
  <div class="shopcartshow" @click="show()">
    <el-button type="primary" icon="el-icon-shopping-cart-2">看看我滴购物车~</el-button>
  </div>
	<div class="shopcart">
    <div class="content" @click="totalList()" v-show="isShow">
      <div class="con-left">
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        gouwuche: require('@/components/shop/child/shopcart/gouwuche.jpg'),
        isShow: false,
        balls: [
          {
            show: false

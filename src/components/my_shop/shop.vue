...
<div>
  <div class="shop-wrapper">
    ...
    <s-ratings v-show="showContent === 'ratings'"></s-ratings>
...
<script>
  ...
  import Goods from './child/goods/goods1.vue'
  ...
  export default {
    ...
    created () {
      this.shopid = this.$route.query.para
      console.log('in create')
      console.log(this.shopid)
      console.log(JSON.parse(sessionStorage.getItem('phone')))
      Axios.get(baseURL + '/store/query_phone?phone=' + JSON.parse(sessionStorage.getItem('phone'))).then((res1) =>{

  ...
  methods: {
    ...
    MenuAdd () {
      this.$refs['elForm'].validate(async valid => {
        ...
        Axios.get(baseURL+'/commodity/insert?store_id=' + this.seller + '&name=' + this.formData.name + '&description=' + this.formData.description + '&price=' + this.formData.price+'&photo='+ encodeURIComponent(this.formData.photo)).then((res) => {

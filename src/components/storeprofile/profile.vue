    ...
    <div class="scroll-content" >
      <div class="scroll">
        ...
        <div class="my-info">
            ...
            <img class="my-avatar" :src="this.tableData.photo">
                ...
                <el-collapse accordion>
                  <el-collapse-item>
                    <template slot="title">
                      ...
                      <div class="aui-list-cell-cn">店铺信息</div>
                    </template>
                    <div>店名:{{tableData.name}}</div>
                    <!--<div>用户身份</div>-->
                    <div>商家手机号:{{tableData.phone}}</div>
                    <div>商家地址:{{tableData.address}}</div>
                    <div>店铺类型:{{type(tableData.type)}}</div>
...
export default {
  ...
  created () {
    Axios.get(baseURL + '/store/query_id?id='+ sessionStorage.getItem('store')).then((res)=>{
      console.log('user center')
      console.log(res.data)
      this.tableData=res.data
      /*var date=Date(this.tableData.bussion_on)
      let h = date.getHours() + ':';
      let m = date.getMinutes() + ':';
      let s = date.getSeconds();
      return h+m+s;*/
      console.log(this.tableData.business_on)
      //console.log($moment(this.tableData.business_on).format('HH:mm:ss'))
      //this.tableData.business_on=$moment(this.tableData.business_on).format('HH:mm:ss')
      //console.log(this.tableData.business_on)
    })
